...
class _MemberPageState extends State<MemberPage> with TickerProviderStateMixin {
            ...
            Positioned(
              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  selectedListKey.currentState?.removeItem(index, (context, animation) => selectedUsersComponent(user: user, index: index, animation: animation), duration: Duration(milliseconds: 300));
  ...
  userComponent({required User user, index, required animation}) {
